...
public final class ConverterGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<ejercicios_propuestos.ejercicio02.converter.ConvertRequest,
      ejercicios_propuestos.ejercicio02.converter.ConvertResponse> getConvertMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Convert",
      requestType = ejercicios_propuestos.ejercicio02.converter.ConvertRequest.class,
      responseType = ejercicios_propuestos.ejercicio02.converter.ConvertResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<ejercicios_propuestos.ejercicio02.converter.ConvertRequest,
      ejercicios_propuestos.ejercicio02.converter.ConvertResponse> getConvertMethod() {
    io.grpc.MethodDescriptor<ejercicios_propuestos.ejercicio02.converter.ConvertRequest, ejercicios_propuestos.ejercicio02.converter.ConvertResponse> getConvertMethod;
      ...
      synchronized (ConverterGrpc.class) {
        if ((getConvertMethod = ConverterGrpc.getConvertMethod) == null) {
          ConverterGrpc.getConvertMethod = getConvertMethod =
              io.grpc.MethodDescriptor.<ejercicios_propuestos.ejercicio02.converter.ConvertRequest, ejercicios_propuestos.ejercicio02.converter.ConvertResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Convert"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ejercicios_propuestos.ejercicio02.converter.ConvertRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ejercicios_propuestos.ejercicio02.converter.ConvertResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void convert(ejercicios_propuestos.ejercicio02.converter.ConvertRequest request,
        io.grpc.stub.StreamObserver<ejercicios_propuestos.ejercicio02.converter.ConvertResponse> responseObserver) {
  ...
  public static final class ConverterStub
    ...
    /**
     */
    public void convert(ejercicios_propuestos.ejercicio02.converter.ConvertRequest request,
        io.grpc.stub.StreamObserver<ejercicios_propuestos.ejercicio02.converter.ConvertResponse> responseObserver) {
  ...
  public static final class ConverterBlockingStub
    ...
    /**
     */
    public ejercicios_propuestos.ejercicio02.converter.ConvertResponse convert(ejercicios_propuestos.ejercicio02.converter.ConvertRequest request) {
  ...
  public static final class ConverterFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<ejercicios_propuestos.ejercicio02.converter.ConvertResponse> convert(
        ejercicios_propuestos.ejercicio02.converter.ConvertRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_CONVERT:
          serviceImpl.convert((ejercicios_propuestos.ejercicio02.converter.ConvertRequest) request,
              (io.grpc.stub.StreamObserver<ejercicios_propuestos.ejercicio02.converter.ConvertResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              ejercicios_propuestos.ejercicio02.converter.ConvertRequest,
              ejercicios_propuestos.ejercicio02.converter.ConvertResponse>(
  ...
  private static abstract class ConverterBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return ejercicios_propuestos.ejercicio02.converter.ConverterProto.getDescriptor();
    }
