...
public final class CalculatorGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "com.calculadora.Calculator";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.calculadora.CalculatorProto.Request,
      com.calculadora.CalculatorProto.Response> getSumMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Sum",
      requestType = com.calculadora.CalculatorProto.Request.class,
      responseType = com.calculadora.CalculatorProto.Response.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.calculadora.CalculatorProto.Request,
      com.calculadora.CalculatorProto.Response> getSumMethod() {
    io.grpc.MethodDescriptor<com.calculadora.CalculatorProto.Request, com.calculadora.CalculatorProto.Response> getSumMethod;
      ...
      synchronized (CalculatorGrpc.class) {
        if ((getSumMethod = CalculatorGrpc.getSumMethod) == null) {
          CalculatorGrpc.getSumMethod = getSumMethod =
              io.grpc.MethodDescriptor.<com.calculadora.CalculatorProto.Request, com.calculadora.CalculatorProto.Response>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Sum"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.calculadora.CalculatorProto.Request.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.calculadora.CalculatorProto.Response.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void sum(com.calculadora.CalculatorProto.Request request,
        io.grpc.stub.StreamObserver<com.calculadora.CalculatorProto.Response> responseObserver) {
  ...
  public static final class CalculatorStub
    ...
    /**
     */
    public void sum(com.calculadora.CalculatorProto.Request request,
        io.grpc.stub.StreamObserver<com.calculadora.CalculatorProto.Response> responseObserver) {
  ...
  public static final class CalculatorBlockingStub
    ...
    /**
     */
    public com.calculadora.CalculatorProto.Response sum(com.calculadora.CalculatorProto.Request request) {
  ...
  public static final class CalculatorFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.calculadora.CalculatorProto.Response> sum(
        com.calculadora.CalculatorProto.Request request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SUM:
          serviceImpl.sum((com.calculadora.CalculatorProto.Request) request,
              (io.grpc.stub.StreamObserver<com.calculadora.CalculatorProto.Response>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.calculadora.CalculatorProto.Request,
              com.calculadora.CalculatorProto.Response>(
  ...
  private static abstract class CalculatorBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.calculadora.CalculatorProto.getDescriptor();
    }
